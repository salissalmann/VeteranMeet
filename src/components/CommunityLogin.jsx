...
{  
    ...
    {
      e.preventDefault();
      const Response = await fetch(`http://localhost:3001/community/login`, {
        method: "POST",
          ...
          <div className="container my-2">
            ...
            <form onSubmit={Submit}>
                ...
                <Box marginTop={"2vw"}  sx={{textDecoration:"none"}}  >          
                    <Typography color={"#6bd5fa"}><Link to="/"> Login as Veteran</Link> <a style={{marginLeft:"1rem"}} href={" "} >OR</a>   <Link to="/SignUp" style={{marginLeft:"1rem"}}> Join as Veteran</Link> </Typography>
                    <Typography color={"#6bd5fa"}><Link to="/CommunityLogin"> Login as Organization</Link> </Typography>
                </Box>          
            </form>
        </div>
